...
export default function Home() {
  ...
  return (
    <main className="flex flex-col min-h-[100dvh] relative overflow-x-hidden overflow-y-auto bg-gradient-to-br from-blue-50/80 via-white to-blue-100/60 p-4 pb-12 pt-32">
